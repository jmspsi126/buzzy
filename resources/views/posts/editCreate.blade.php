@extends("app")
@section('head_title', trans('addpost.edit', ['type' => $typenetitle ]).' | '.getcong('sitename'))
@section("header")
                ...
                <div class="question-post-form" data-type="{{ $typene }}">
                    ...
                    <fieldset>
                        ...
                        <section class="form">
                            ...
                            <legend>{{ trans('addpost.order') }}</legend>
                            <div class="cd-form">
                                {!! Form::text('order', $post->order, ['class' => 'cd-input ', 'placeholder' => trans('addpost.orderplace')]) !!}
                                {{--<input class="cd-input" type="number" name="order" value="{{ $post->order }}" placeholder="{{ trans('addpost.orderplace') }}">--}}
                            </div>
                        </section>
                        @if($typene=='list')
                        <section class="form">
