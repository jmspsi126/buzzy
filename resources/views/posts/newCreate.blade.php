                        ...
                        <section class="form this-pro" >
                            ...
                            <div id="entries">
                               ...
                               @if($typene=='poll')
                                        ...
                                        <a class="button button-blue button-big submit-button postable texr" data-method="Get" data-target="entries" data-puttype="append" data-type="pollform" href="{{ action('FormController@addnewform') }}?addnew=poll" ><i class="fa fa-check-circle-o"></i>{{ trans('addpost.add', ['type' => trans('addpost.option')]) }}</a>
                             </div>
                                @endif
                            @if($typene=='quiz')
