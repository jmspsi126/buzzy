        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-purple">
                    <div class="box-header with-border">
                        <h3 class="box-title">Recently Added Quizzes</h3>
                        <div class="box-tools pull-right">
                            <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                            <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                        </div>
                    ...
                    <div class="box-body">
                        <ul class="products-list product-list-in-box">
                            @foreach($lastquizzes as $item)
                                @include('._admin._particles.items.item_lists')
                            @endforeach
                        </ul>
                    </div><!-- /.box-body -->
                    <div class="box-footer text-center">
                        <a href="/admin/quizzes" class="uppercase">View All Quizzes</a>
                    </div><!-- /.box-footer -->
                </div>
            </div>
        </div>
                                ...
                                <td>
                                    ...
                                    @elseif($item->type == 'list')
                                     ...
                                     @elseif($item->type == 'quiz')
                                        <span class="label bg-purple"><i class="fa fa-th-list"></i>&nbsp;Quiz</span>
            ...
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    <ul class="nav nav-tabs pull-right" style="border:0">
                        ...
                        <li><a href="#quizzes-chart" style="color:#000;border-radius: 5px;"  class="btn btn-box-tool box-line-get" data-type="quizzes" data-toggle="tab">Quizzes</a></li>
