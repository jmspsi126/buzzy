        ...
        <h2 class="item_title">
            ...
            <div class="item_meta">
                ...
                <div class="item_meta__item pull-r" style="margin-right: 0; ">
                        <a href="http://www.facebook.com/share.php?u={{ url(makeposturl($item)) }}" class="share_social is-facebook  popup-action"><i class="fa fa-facebook"></i></a>
                        <a href="http://twitter.com/share?url={{ url(makeposturl($item)) }}&amp;text={{ $item->title  }}" class="share_social is-twitter popup-action"><i class="fa fa-twitter"></i></a>
                 </div>
         </div>
                @endunless
