    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <h1>
            Buzzy Documentation
            <small>Current version 1.3</small>
          </h1>
          <ol class="breadcrumb">
    ...
    <p class="lead">
      <H3>Server Requirements</H3>
       Checking to ensure that your web host have the minimum requirements to run Buzzy.
        ...
        <p>Laravel 5.1(the framework used in our script) system requirements.</p>
        <ul>
          <li>PHP >= 5.5.9</li>
...
<section id="configuration">
  ...
  <div class="callout callout-info lead">
    ...
    <p>
      ...
      <a href="/docsassets/ss/sstwiterapp.jpg">See Full Twitter App Settings.</A>
      <br>
      Then must check "Request email addresses from users" checkbox on your Twitter App permission tab.
      <a href="/docsassets/ss/sstwitterper.jpg">See Full Twitter Permission Settings.</A>
    </p>
  </div>
  <h4>Google</h4>
    <ul>
...
<section id="languages">
  ...
  <div class="callout callout-danger lead">
    ...
    <p>Send your language files and We will support your language on the next updates. <code>contact[at]akbilisim.com</code></p>
  </div>
</section><!-- /#introduction -->
