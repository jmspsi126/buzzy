...
Route::group(['middleware' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::get('news', 'Admin\PostsController@news');
    Route::get('lists', 'Admin\PostsController@lists');
    Route::get('quizzes', 'Admin\PostsController@quizzes');
    Route::get('polls', 'Admin\PostsController@polls');
    Route::get('videos', 'Admin\PostsController@videos');
